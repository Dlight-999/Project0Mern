    ...
    <div className='relative overflow-hidden'>
        ...
        <div className='absolute inset-0 flex justify-center items-center text-white bg-black/65 shadow-black shadow-lg rounded-md text-center'>
            <div className='mx-auto'>
                <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold'>Adventure Pokhara</h1>
                <h2 className='mt-4 text-lg md:text-xl flex'>Embark on an Adventure of a Lifetime!</h2>
                <p className='mt-2 text-lg md:text-xl'>Discover Exciting Destinations and Create Lasting Memories</p>
